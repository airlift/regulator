...
import io.airlift.regulator.Re2.Anchor;
...
import static io.airlift.regulator.Re2BenchmarkRunner.compileRe2;
...
public class BenchmarkRe2SearchExtra
{
    ...
    @Benchmark
    public boolean searchEasy2DfaBoolean(SearchState state)
    {
        return Re2BenchmarkRunner.searchDfaBoolean(state.progEasy2, state.text, false);
    }

    @Benchmark
    public boolean searchEasy2Re2(SearchState state)
    {
        return state.re2Easy2.find(state.text);
    }

    // ========== Fanout (Unicode) ==========

    @Benchmark
    public boolean searchFanoutDfaBoolean(SearchState state)
    {
        return Re2BenchmarkRunner.searchDfaBoolean(state.progFanout, state.text, false);
    }

    @Benchmark
    public boolean searchFanoutRe2(SearchState state)
    {
        return state.re2Fanout.find(state.text);
    }

    // ========== BigFixed (dynamic pattern) ==========

    @Benchmark
    public boolean searchBigFixedDfaBoolean(BigFixedState state)
    {
        return Re2BenchmarkRunner.searchDfaBoolean(state.progBigFixed, state.text, false);
    }

    @Benchmark
    public boolean searchBigFixedRe2(BigFixedState state)
    {
        return state.re2BigFixed.find(state.text);
    }

    // ========== Success (anchored .*$) ==========

    @Benchmark
    public boolean searchSuccessDfaBoolean(SearchState state)
    {
        return Re2BenchmarkRunner.searchDfaBoolean(state.progSuccess, state.text, true);
    }

    @Benchmark
    public boolean searchSuccessNfa(SearchState state)
    {
        return Nfa.search(state.progSuccess, state.text, true, Prog.MatchKind.LONGEST_MATCH, null);
    }

    @Benchmark
    public boolean searchSuccessRe2FullMatch(SearchState state)
    {
        return state.re2Success.matches(state.text);
    }
    ...
    @Benchmark
    public boolean searchSuccess1DfaBoolean(SearchState state)
    {
        return Re2BenchmarkRunner.searchDfaBoolean(state.progSuccess1, state.text, true);
    }

    @Benchmark
    public boolean searchSuccess1Re2FullMatch(SearchState state)
    {
        return state.re2Success1.matches(state.text);
    }
    ...
    @Benchmark
    public boolean searchAltMatchDfaBoolean(SearchState state)
    {
        return Re2BenchmarkRunner.searchDfaBoolean(state.progAltMatch, state.text, true);
    }

    @Benchmark
    public boolean searchAltMatchNfa(SearchState state)
    {
        return Nfa.search(state.progAltMatch, state.text, true, Prog.MatchKind.LONGEST_MATCH, null);
    }

    @Benchmark
    public boolean searchAltMatchRe2FullMatch(SearchState state)
    {
        return state.re2AltMatch.matches(state.text);
    }
    ...
    @Benchmark
    public boolean searchDigitsDfaBoolean(DigitsState state)
    {
        return Re2BenchmarkRunner.searchDfaBoolean(state.progDigits, state.text, true);
    }
