...
public class TestUpstreamCharClassBuilder
{
    ...
    public void testAddsRemoveAboveNegateAndCopy()
    {
        ...
        Case[] cases = new Case[] {
                ...
                new Case(
                        new Range[] {Range.of(13, 14), Range.of(10, 11), Range.of(22, 23), Range.of(19, 20), Range.of(16, 17)},
                        -1,
                        new Range[] {Range.of(10, 11), Range.of(13, 14), Range.of(16, 17), Range.of(19, 20), Range.of(22, 23)}),

                // Wide range that swallows multiple existing ranges.
                new Case(
                        new Range[] {Range.of(13, 14), Range.of(10, 11), Range.of(22, 23), Range.of(19, 20), Range.of(16, 17), Range.of(5, 25)},
                        -1,
                        new Range[] {Range.of(5, 25)}),

                // Bridge range that merges adjacent ranges.
                new Case(
                        new Range[] {Range.of(13, 14), Range.of(10, 11), Range.of(22, 23), Range.of(19, 20), Range.of(16, 17), Range.of(12, 21)},
                        -1,
