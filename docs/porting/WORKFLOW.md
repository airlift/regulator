...
Use this workflow when changing Regulator's RE2 implementation. The
[test map](TEST_MAP.md) records upstream coverage, and the
[maintenance guide](../MAINTAINING_REGULATOR.md) defines the required checks.

## Before changing code

1. Read the corresponding source at pinned upstream commit
   `972a15cedd008d846f1a39b2e88ce48d7f166cbd`.
2. Read [`REGULATOR_DECISIONS.md`](../../REGULATOR_DECISIONS.md) and
...
`io.airlift.regulator.Tester` is the shared differential harness. Extend
...
- Keep production changes within `io.airlift.regulator` unless integration
