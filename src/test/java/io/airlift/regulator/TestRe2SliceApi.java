...
public class TestRe2SliceApi
{
    ...
    public void testOneShotMatchingAndCaptures()
    {
        ...
        assertThat(pattern.matches(input)).isFalse();
    ...
    public void testLogicalSliceOffsets()
    {
        ...
        assertThat(pattern.matchesResult(input).groupSlice(2).toStringUtf8()).isEqualTo("42");
    }
    ...
    public void testCompiledPatternOwnsPatternBytes()
    {
        ...
        assertThat(pattern.matches(Slices.utf8Slice("abc"))).isTrue();
        assertThat(pattern.matches(Slices.utf8Slice("xbc"))).isFalse();
    }
