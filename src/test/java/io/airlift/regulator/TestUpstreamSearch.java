...
public class TestUpstreamSearch
{
    ...
    private static final String UPSTREAM_CORPUS_SHA256 = "03de8666830c3b805d21f37d437977c0b7d26513a8e1af92f8c28f18d674acc9";
            ...
            throws Exception
    {
        ...
        byte[] corpus;
        try (InputStream in = TestUpstreamSearch.class.getResourceAsStream("/io/airlift/regulator/testing/upstream_search_test_cases.base64")) {
            if (in == null) {
                throw new IOException("missing resource: upstream_search_test_cases.base64");
            }
            corpus = in.readAllBytes();
        }
        assertThat(HexFormat.of().formatHex(MessageDigest.getInstance("SHA-256").digest(corpus)))
                .as("pinned upstream search corpus")
                .isEqualTo(UPSTREAM_CORPUS_SHA256);

        try (BufferedReader reader = new BufferedReader(new InputStreamReader(new ByteArrayInputStream(corpus), US_ASCII))) {
            String line;
            int lineNumber = 0;
